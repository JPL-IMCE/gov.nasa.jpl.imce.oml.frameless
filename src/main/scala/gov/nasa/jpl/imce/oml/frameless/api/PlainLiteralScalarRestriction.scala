...
case class PlainLiteralScalarRestriction(
  ...
  length: scala.Option[taggedTypes.PositiveIntegerLiteral],
    
  minLength: scala.Option[taggedTypes.PositiveIntegerLiteral],
    
  maxLength: scala.Option[taggedTypes.PositiveIntegerLiteral],
    
  name: taggedTypes.LocalName,
    
  langRange: scala.Option[taggedTypes.LanguageTagDataType],
    
  pattern: scala.Option[taggedTypes.LiteralPattern]
)
