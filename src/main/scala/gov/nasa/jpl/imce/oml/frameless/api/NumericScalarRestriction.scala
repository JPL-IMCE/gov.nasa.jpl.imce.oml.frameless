...
case class NumericScalarRestriction(
  ...
  minExclusive: scala.Option[LiteralNumber],
    
  minInclusive: scala.Option[LiteralNumber],
    
  maxExclusive: scala.Option[LiteralNumber],
    
  maxInclusive: scala.Option[LiteralNumber],
